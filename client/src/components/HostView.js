...
class HostView extends Component {
  ...
  render() {
    const challongeURL = this.props.brackette.subdomain
      ? `http://${this.props.brackette.subdomain}.challonge.com/${this.props
          .brackette.tournamentId}/module`
      : `http://challonge.com/${this.props.brackette.tournamentId}/module`;
    return (
      <Tabs
        tabItemContainerStyle={{ backgroundColor: "#FFEB3B" }}
        inkBarStyle={{ backgroundColor: "#00E6FF" }}
      >
